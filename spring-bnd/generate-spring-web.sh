...
sed -i.bak s/${version}/${version}_OSGI3/g *.pom

bnd spring-web.bnd

jar xf spring-web-${version}.jar META-INF ; rm META-INF/MANIFEST.MF ; jar uf spring-web-${version}_OSGI3.jar META-INF/* ; rm -Rf META-INF

mvn install:install-file -Dfile=spring-web-${version}_OSGI3.jar -DpomFile=spring-web-${version}.pom
